...
Use `docs/02-design-system.md` as the primary UX and visual direction for Vietnamese admin apps: dense, operational, table-first, keyboard-friendly, low-ornament, and optimized for 1366px to 1920px desktop workflows.
