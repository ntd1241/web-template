create index if not exists contracts_tenant_customer_id_idx
  on public.contracts (tenant_id, customer_id);

create index if not exists customers_tenant_customer_code_idx
