...
export function Header() {
  ...
  return (
    <header className="fixed end-0 start-0 top-0 z-10 flex h-(--header-height-mobile) shrink-0 items-center justify-between border-b border-agribase-grey-100 bg-agribase-surface px-5 lg:start-[var(--sidebar-width)] lg:h-(--header-height) lg:px-8">
      ...
      <button
        className="flex shrink-0 items-center gap-3 rounded-lg p-1.5 text-left transition-colors hover:bg-agribase-surface-alt"
        type="button"
      >
        ...
        <span className="flex size-10 items-center justify-center rounded-full border border-agribase-amber-light bg-gradient-to-br from-[#fff3e0] to-[#ffb74d] text-[16px] font-bold text-[#f57c00] shadow-sm">
          T
        </span>
      </button>
    </header>
