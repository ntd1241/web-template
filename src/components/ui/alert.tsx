  ...
  'flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)',
  {
    ...
    compoundVariants: [
      ...
      },
      {
        variant: 'blue',
        appearance: 'solid',
        className: 'bg-admin-blue-primary text-white',
      },
      {
        variant: 'destructive',
        appearance: 'solid',
      ...
      },
      {
        ...
        appearance: 'outline',
        className:
          'border border-admin-blue-border bg-background text-admin-blue-primary [&_[data-slot=alert-close]]:text-foreground',
      },
      {
        variant: 'destructive',
        appearance: 'outline',
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'bg-admin-blue-bg border border-admin-blue-border text-foreground [&_[data-slot=alert-icon]]:text-admin-blue-primary',
      },
      {
        variant: 'destructive',
        appearance: 'light',
      ...
      },
      {
        variant: 'mono',
        icon: 'blue',
        className: '[&_[data-slot=alert-icon]]:text-admin-blue-primary',
      },
      {
        variant: 'mono',
        icon: 'warning',
