...
function TableHead({
  ...
  return (
    <th
      ...
      className={cn(
        'h-10 bg-muted px-4 text-left align-middle text-[12px] font-semibold normal-case tracking-[0.01em] text-secondary-foreground rtl:text-right [&:has([role=checkbox])]:pe-0',
        className,
      )}
      {...props}
    />
