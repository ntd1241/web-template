...
const textareaVariants = cva(
  `
    w-full bg-admin-surface-alt focus-visible:bg-background border border-input text-foreground shadow-xs shadow-black/5 transition-[color,box-shadow,background-color]
