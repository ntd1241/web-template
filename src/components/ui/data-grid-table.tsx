...
function DataGridTableHeadRowCell<TData>({
  ...
  return (
    <th
      ...
      className={cn(
        'relative h-10 text-left rtl:text-right align-middle text-[12px] font-semibold normal-case tracking-[0.01em] text-secondary-foreground [&:has([role=checkbox])]:pe-0',
        headerCellSpacing,
