...
export function InputSelect({
  ...
  return (
    <div
      ...
      className={cn(
        'flex min-h-8.5 w-full items-stretch overflow-hidden rounded-md border border-input bg-background shadow-xs shadow-black/5 transition-[color,border-color,box-shadow,background-color] duration-200 ease-out has-[:focus-visible]:border-ring has-[:focus-visible]:bg-background has-[:focus-visible]:outline-none has-[:focus-visible]:ring-[3px] has-[:focus-visible]:ring-ring/30',
