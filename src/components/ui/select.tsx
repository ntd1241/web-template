...
const selectTriggerVariants = cva(
  `
    flex bg-background data-[state=open]:bg-background focus-visible:bg-background w-full items-center justify-between outline-none border border-input shadow-xs shadow-black/5 transition-[color,border-color,box-shadow,background-color] duration-200 ease-out
