/**
 * Scaffolded by column-filter-builder from `src/project/contracts/table/contract-column-filters.fixture.ts`. Run `npm run gen:column-filter` — do NOT hand-write this file.
