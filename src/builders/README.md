...
| `editor-table` | `<Entity>EditorTable` RHF field-array table with editable cells, sticky action column, and viewport modes | `EditorTableSpec` (`@/builders/editor-table`) | `tsx tools/builders/cli/gen-editor-table.ts <spec> <out>` | building spreadsheet-like edit tables inside edit pages | [`src/builders/editor-table/README.md`](./editor-table/README.md)    |
