...
2. Read `docs/workflows/implement-ui.md`, then open only the guide linked by the matching registry row and scaffold from the required spec.
...
5. If no builder fits, implement with `docs/06-component-usage-guide.md` and `src/components/ui` primitives. If the same surface will repeat, consider adding a builder using `docs/builders/authoring.md`.
...
- Run the builder-specific tests documented by the matching guide when touching builder code or generated consistency.
